    ...
    <React.Fragment>
      <footer className="flex flex-col justify-center items-center bg-indigo-700 bg-opacity-70 w-full h-40">
        <div className="flex justify-center items-center relative">
          ...
          >
            <i className="fab fa-twitter text-pink-50 hover:text-pink-200 focus:text-pink-200 active:text-pink-300 text-3xl hover:cursor-pointer duration-200"></i>
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <i className="fab fa-github text-pink-50 hover:text-pink-200 focus:text-pink-200 active:text-pink-300 text-3xl ml-6 hover:cursor-pointer duration-200"></i>
          </a>
        </div>
