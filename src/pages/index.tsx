    ...
    <Layout location={location}>
      ...
      <Main>
        <Section background="opaque" className="mb-8 -mt-10">
          ...
          <h2 className="mt-10 text-2xl tracking-wide text-gray-700">Design systems engineer &amp; solutions architect <br /><span className="text-xl text-gray-600">🏳️‍🌈 she/her 🏳️‍⚧️</span></h2>
