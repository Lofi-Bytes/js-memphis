    ...
    <Layout>
      ...
      <main className="min-h-screen max-w-screen-lg m-auto">
        <section className="bg-gray-100 rounded-xl p-8 w-2/3 mx-auto -mt-12 mb-10 shadow-xl relative">
          <Avatar />
          <h2 className="text-gray-800 text-2xl mt-6">About Me</h2>
          <p className="text-gray-600 tracking-wider mt-4">
          ...
          <h3 className="text-gray-700 text-xl mt-10">Current Work</h3>
          <p className="text-gray-600 tracking-wider mt-4">
          ...
          <h3 className="text-gray-700 text-xl mt-10">Previous Work</h3>
          <p className="text-gray-600 tracking-wider mt-4">
          ...
          <h3 className="text-gray-700 text-xl mt-10">Education</h3>
          <p className="text-gray-600 tracking-wider mt-4">
          ...
          <h3 className="text-gray-700 text-xl mt-10">Extracurricular Interests</h3>
          <p className="text-gray-600 tracking-wider mt-4">
        ...
        <section className="bg-gray-100 rounded-xl p-8 pb-10 w-2/3 mx-auto mb-20 shadow-xl z-10 relative">
          <h2 className="text-gray-800 text-2xl">Say Hello</h2>
